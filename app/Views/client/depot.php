...
<head>
    ...
    <title>Effectuer un dépôt - KazziPay</title>
    <!-- Bootstrap local -->
...
<body>
    <div class="login-wrapper">
        ...
        <div class="card-operation">
            <h2><i class="bi bi-box-arrow-in-down me-2"></i>Effectuer un dépôt</h2>
            <hr>
            ...
            <form method="post" action="/client/depot/traitement">
                ...
                <button type="submit" class="btn btn-depot w-100 mt-2">
                    <i class="bi bi-check-lg me-2"></i>Déposer
                </button>
            </form>
